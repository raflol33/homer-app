...
export class ExportDialogComponent implements OnInit {
    ...
    export() {
        if (this.params.type === 'CSV') {
            ...
            const workbook = XLSX.read(this.apiPoint.getDataAsCsv(this.params.gridExport), { type: 'string', raw: true });
            XLSX.writeFile(workbook, `${this.params.gridExport.fileName}.xlsx`);
        }
    }
    onNoClick(): void {
